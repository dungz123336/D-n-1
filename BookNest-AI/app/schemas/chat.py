...
class ChatContext(BaseModel):
    """Client-supplied browsing/commerce context for personalization."""

    customer_id: Optional[int] = None
    current_page: Optional[str] = None
    current_book_id: Optional[int] = None
    current_category: Optional[str] = None
    # Full current book from the website (preferred over AI-local DB)
    current_book: Optional[dict[str, Any]] = None
    # Live inventory snapshot from the website catalog — absolute source of truth
